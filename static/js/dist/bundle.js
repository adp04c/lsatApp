...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.renderApp = function (props) {
	    var component = __webpack_require__(159)("./" + store.component);
	    var domContainerNode = document.getElementById('app-container');
	...
	window.renderApp = function (props) {
	    var component = __webpack_require__(159)("./" + store2.component);
	    var domContainerNode = document.getElementById('app-container2');
	    // Unmounting the component before mounting it again
	    ReactDOM.unmountComponentAtNode(domContainerNode);
	    ReactDOM.render(React.createFactory(component)(props), domContainerNode);
	};
		...
		_createClass(CommentBox, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_CommentList2.default, { comments: this.props.comments }),
					_react2.default.createElement(_CommentForm2.default, { url: this.props.url })
				);
			}
		}]);
		...
		_createClass(CommentList, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-danger', onClick: this.clearAll },
						'Clear All'
					),
					commentNodes
				);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        null,
	                        'Say something...',
	                        _react2.default.createElement('textarea', { id: 'comment', name: 'text', className: 'form-control', placeholder: '...' })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'btn btn-primary', onClick: this.submitComment },
	                        'Submit'
	                    )
	                )
	            );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ChildComponent = __webpack_require__(179);
	...
	var banner = function (_React$Component) {
	    ...
	    function banner() {
	        ...
	        _this.changeChildText = _this.changeChildText.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(banner, [{
	        ...
	        key: 'changeChildText',
	        value: function changeChildText() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_ChildComponent2.default, { childText: this.changeChildText() }),
	                _react2.default.createElement(_Button2.default, { onClick: this.toggle })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // import node modules
